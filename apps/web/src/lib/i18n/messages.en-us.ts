...
export const enUSMessages: WebMessages = {
  ...
  notifications: {
    ...
    types: {
      ...
      OVERVIEW_COVERAGE_RENEWED: "Overview coverage renewed",
      unknown: (type) => type,
    },
    failureTitles: {
      ...
      pihole_response_error: "Pi-hole response error",
      unknown: "Failed to reach the instance",
    },
  },
  overview: {
    ...
    coverage: {
      ...
      description: "Stored periods for the selected scope, with emphasis on windows that are close to expiring.",
      totalStoredQueries: "Stored queries",
      earliestStoredAt: "Earliest record",
      latestStoredAt: "Latest record",
      savedWindows: "Stored periods",
      expiringSoon: "Expiring soon",
      unavailable: "N/A",
      emptyTitle: "No stored coverage",
      emptyDescription: "No completed import was found for the current scope.",
      completedEmptyTitle: "No completed period",
      completedEmptyDescription: "Only periods with Success or Partial status are shown in this list.",
      ...
      renew: "Renew +30 days",
      renewing: "Renewing...",
      expiringSoonTitle: "Coverage close to expiration",
      expiringSoonDescription: (count) =>
        `${count} stored period(s) will expire soon and can be renewed without fetching again.`,
    ...
    ranking: {
      ...
      savedDatesDescription: "Choose the saved-day range used by rankings and charts.",
      ...
      savedDateFromLabel: "Start date",
      savedDateUntilLabel: "End date",
      ...
      backToPreviousPeriod: "Back to previous period",
      drillDownLoading: "Loading period...",
      deletePeriodDialogTitle: "Delete selected period?",
      deletePeriodDialogDescription: (period) =>
        `This queues a job to delete stored data between ${period}. Rankings for this interval will be unavailable until a new import runs.`,
      deletePeriodDialogConfirm: "Delete period",
      deletePeriodDialogCancel: "Cancel",
      nativeWindowNoticeTitle: "Pi-hole vs YAPD time window",
      nativeWindowNoticeDescription:
        "The native Pi-hole dashboard often processes dates only up to minute 55. YAPD evaluates the full range until 23:59:59, so totals can differ.",
      statusDistributionTitle: "Status distribution",
      statusDistributionDescription: "Share of the leading statuses within the filtered universe.",
      kpis: {
        peakQueries: "Period peak",
        peakBlocked: "Blocked peak",
        topDomain: "Leading domain",
        topClient: "Leading client",
        topUpstream: "Leading upstream",
        topStatus: "Leading status",
        noValue: "No data",
      },
      analytics: {
        contextTitle: "Analyzed universe",
        filteredContextTitle: "Filtered universe",
        contextDescription: (from, until) =>
          `Period from ${from} to ${until}. Percentages are calculated over this set.`,
        clientContext: (clientIp) => `Client: ${clientIp}`,
        domainContext: (domain) => `Domain: ${domain}`,
        groupContext: (group) => `Grouping: ${group}`,
        totalQueries: "Total",
        allowedQueries: "Allowed",
        blockedQueries: "Blocked",
        blockedPercentage: "% blocked",
        topDomainsShareTitle: "Domain share",
        topDomainsShareDescription: "Top domains and their share of the filtered universe.",
        topClientsShareTitle: "Clients by volume",
        topClientsShareDescription: "Client volume and share within the selected period.",
        hourlyAccessTitle: "Hours with most accesses",
        hourlyAccessDescription: "Sum by hour of day within the selected period.",
        hourlyAccessUnavailable: "Use hourly grouping to view the hourly distribution.",
        hourlyAccessPeak: (hour, count) => `Highest volume at ${hour}: ${count} queries.`,
        domainColumn: "Domain",
        clientColumn: "Client",
        totalColumn: "Total",
        percentageColumn: "%",
      ...
      showUpstreams: "Show upstreams",
      hideUpstreams: "Hide upstreams",
    ...
    jobs: {
      ...
      filteredEmptyTitle: "No job in this filter",
      ...
      elapsedDuration: (value) => `Elapsed: ${value}`,
      ...
      detailsScope: "Scope",
      detailsAllInstances: "All instances",
      detailsOrigin: "Origin",
      detailsOriginAutomatic: "Automatic import",
      detailsOriginManual: "Manual import",
      detailsPeriodLabel: "Period",
      detailsRecordsFiltered: "recordsFiltered",
      detailsTotalPages: "Total pages",
      detailsExpected: "Expected total",
      detailsSaved: "Saved total",
      detailsAttempts: "Attempts",
      detailsProgressTitle: "Consolidated progress",
      detailsCompletedPercentage: "% completed",
      detailsExecutionTitle: "Execution",
      detailsCreatedAt: "Created at",
      detailsStartedAt: "Started at",
      detailsFinishedAt: "Finished at",
      detailsUnavailable: "N/A",
      detailsFailureTitle: "Primary failure reason",
      detailsFailureInstance: (instanceName) => `Instance: ${instanceName}`,
      detailsFailurePage: (page) => `Page: ${page}`,
      detailsRetryAt: (value) => `Retry: ${value}`,
      detailsLastSuccessTitle: "Last successful step",
      detailsLastSuccessInstance: (instanceName) => `Instance: ${instanceName}`,
      detailsLastSuccessPage: (page) => `Page: ${page}`,
      detailsLastSuccessAt: (value) => `Completed at: ${value}`,
      detailsStalledTitle: "Execution stalled at",
      detailsStalledInstance: (instanceName) => `Instance: ${instanceName}`,
      detailsStalledPage: (page) => `Page: ${page}`,
      detailsStalledStart: (value) => `Start offset: ${value}`,
      detailsCheckpointTitle: "Current checkpoint",
      detailsCheckpointInstance: "Instance",
      detailsCheckpointPage: "Page",
      detailsCheckpointStart: "Start offset",
      detailsCheckpointFailures: "Consecutive failures",
      detailsNoCheckpoint: "There is no active checkpoint.",
      detailsInstancesTitle: "Per-instance progress",
      detailsTimelineTitle: "Event timeline",
      detailsNoTimeline: "No events were recorded for this job.",
      failureReason: {
        timeout: "Timeout",
    ...
    settings: {
      ...
      name: "Name",
      namePlaceholder: "Primary daily import",
      enabled: "Enabled",
      enabledDescription: "Disabled rules stay saved but do not schedule jobs.",
      target: "Instance",
      allInstances: "All instances",
      missingInstance: "Unavailable instance",
      preset: "Preset",
      presets: {
        daily3: "Every day at 03:00",
        daily0: "Every day at 00:00",
        daily6: "Every day at 06:00",
        hourly: "Every hour",
      ...
      emptyTitle: "No configured rule",
      emptyDescription: "Create a rule to schedule automatic d-1 imports.",
      deleteDialogTitle: "Delete automatic rule?",
      deleteDialogDescription: (name) => `The "${name}" rule will stop scheduling new automatic imports.`,
      deleteDialogConfirm: "Delete rule",
    ...
    notifications: {
      ...
      coverageRenewedMessage: (from, until, expiresAt) =>
        `Coverage between ${from} and ${until} renewed until ${expiresAt}.`,
    },
    toasts: {
      ...
      jobDetailsFailed: "Could not load this job details.",
      currentDayBlocked: "Historical overview does not allow the current date. Choose at most the previous closed day.",
      ...
      automaticImportsRefreshFailed: "Could not refresh automatic rules.",
      automaticImportSaved: "Automatic rule saved.",
      automaticImportSaveFailed: "Could not save the automatic rule.",
      automaticImportDeleted: "Automatic rule deleted.",
      automaticImportDeleteFailed: "Could not delete the automatic rule.",
    },
  },
  queries: {
  ...
  browserExtension: {
    ...
    description: "Manage extension pairing, devices, settings, and submission history.",
    pairing: {
      title: "Pairing",
      description: "Generate a temporary code to connect an extension to YAPD.",
      generate: "Generate code",
      generating: "Generating...",
      code: "Code",
      expiresAt: "Expires at",
      empty: "No active code in this view.",
    },
    devices: {
      title: "Paired devices",
      description: "Active and revoked extension tokens.",
      name: "Name",
      browser: "Browser",
      version: "Version",
      manifest: "Manifest",
    ...
    settings: {
      title: "Settings",
      description: "Preferences sent to the extension during cache sync.",
      sendPageTitle: "Send page title",
      hardBlocked: "URLs blocked from inspection",
    ...
    history: {
      title: "History",
      description: "Items detected by the extension consolidated by main domain.",
      date: "Date",
      pageDomain: "Page",
      count: "Items",
      blocked: "Blocked",
    ...
    toasts: {
      pairingCreated: "Pairing code created.",
      pairingFailed: "Could not generate the pairing code.",
      settingsSaved: "Settings saved.",
      settingsFailed: "Could not save settings.",
      deviceRevoked: "Device revoked.",
      revokeFailed: "Could not revoke the device.",
      refreshFailed: "Could not refresh Inspector data.",
    },
  },
  config: {

...
interface CreateDomainGroupSelectorProps {
...
export function CreateDomainGroupSelector({
  groups,
  selectedGroupIds,
  onChange,
  disabled,
}: CreateDomainGroupSelectorProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="max-h-64 space-y-2 overflow-y-auto pr-1">
          {groups.map((group) => {
            const checkboxId = `create-domain-groups-${group.id}`;
            return (
